...
sudo docker exec -d clab-frr01-PC1 ip addr add 192.0.2.2/24 dev eth2
sudo docker exec -d clab-frr01-PC1 ip route add 0.0.0.0/0 via 192.0.2.1 dev eth2
...
sudo docker exec -d clab-frr01-PC2 ip addr add 203.0.113.2/24 dev eth2
